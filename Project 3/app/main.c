...
int main(int argc, char *argv[])
{
	 ...
	 * αρχικα στο train ειναι μεγαλο για το τεστ και τρωει segmentation. Δυο λυσεις σκεφτηκα. Ή αλλαζουμε το batch size
	 * σε κατι αλλο για το τεστ ή ακομα καλυτερα διαιρουμε το πληθος των test samples σε σχεδον ισα μερη οσα και τα
	 * θρεντς και ετσι τα θρεντς εχουν ιδιο φορτο.
	 * Αν θες κοιτα το αλλα θα το κανω ουτως ή αλλως μετα το μαθημα. Επισης νομιζω οτι αυτο παιζει σαν σεναριο και στο
	 * τρειν. */
	...
	// 		for (int j = 0; j < total_data_files; j++) {
	// 			if (i != j) {
